...
-- * Generation date: Tue Aug 24 23:18:57 2021 
...
create database completo-logico;
...
create table ESECUZIONI_TRATTE (
...
create table PRENOTAZIONI (
     ...
     DataOraImbarco date not null,
     DataOraSbarco date not null,
...
alter table ESECUZIONI_TRATTE add constraint FKComprende
     foreign key (CodNavigazione)
     references NAVIGAZIONI;

alter table ESECUZIONI_TRATTE add constraint FKAttivazione
