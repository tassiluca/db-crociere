...
-- * Generation date: Tue Jul 13 18:46:21 2021 
...
use completo-ristrutturato-manina;
...
create table INTRATTENIMENTO (
     ...
     CodAttività int not null,
     CodSala char(3) not null,
     CodNavigazione int not null,
...
create table NAVIGAZIONE (
     CodNavigazione int not null auto_increment,
...
create table PAGAMENTO (
     CodTransazione int not null auto_increment,
     Data date not null,
...
create table PRENOTAZIONE (
     ...
     CodTransazione int not null,
     NomeNave varchar(30) not null,
     NumeroPonte int not null,
     CodCabina int not null,
     CodiceFiscale char(16) not null,
     Trattamento varchar(13) not null,
     CodTariffario int not null,
     CodNavigazione int not null,
...
create table RIMBORSO (
     CodRimborso int not null auto_increment,
     PreavvisoDal char(1) not null,
     PreavvisoAl char(1) not null,
     PercentualeRimborso int not null,
...
create table SCIALUPPA (
     CodScialuppa int not null auto_increment,
...
create table SPESA_EXTRA (
     CodiceSpesa int not null auto_increment,
     Data date not null,
     Importo int not null,
...
create table TARIFFARIO (
     CodTariffario int not null auto_increment,
...
create table TRATTA (
     CodTratta int not null auto_increment,
...
create table TRATTA_IN_NAVIGAZIONE (
     CodTrattaNavigazione int not null auto_increment,
...
alter table ANNULLAMENTI add constraint FKAnn_RIM
     ...
     references RIMBORSO (CodRimborso);
...
alter table BADGE add constraint FKRiferimento
     ...
     references CABINA (NomeNave, NumeroPonte, CodCabina);
...
alter table INTRATTENIMENTO add constraint FKOfferta
     ...
     references NAVIGAZIONE (CodNavigazione);
...
alter table NAVE add constraint FKAssociata_FK
     ...
     references PERCORSO (CodicePercorso);
...
alter table PRENOTAZIONE add constraint FKPrevede_FK
     ...
     references PAGAMENTO (CodTransazione);
...
alter table PRENOTAZIONE add constraint FKApplicato
     ...
     references TARIFFARIO (CodTariffario);
...
alter table RESPONSABILITÀ add constraint FKResponsabilitàTurno
     ...
     references TURNO_LAVORATIVO (CodiceFiscale, InizioData, InizioOra);
